...
#include "string.h"       // strtok, strstr, strcpy, strlen vs.
#include "stdlib.h"       // atof, atoi gibi dönüşüm fonksiyonları için
#include "stdio.h"        // printf gibi fonksiyonlar için (konsol debug vs.)
